...
file.out = "/Work/Research/Macrosystems/FIA Phase Space/Data/ESMrawRKv09.rds"
...
# ---------- SUBSET FOR OUTPUT
  cat("Subsetting...\n")
  OUT = ALL[, .(
    TRE_CN, PREV_TRE_CN, PLT_CN, PREV_PLT_CN, STATECD, 
    SPCD, PFT, PREV_TRE_SPCD, PREV_TRE_PFT, in.TA, 
    INVYR, REMPER, PREVYR,
    DIA_BEGIN, DIA_END, PREVDIAmean, DIAmean, 
    start1tpa, end1tpa, PREVTPAsum,  TPAsum,
    STOCKING5, STOCKING5mid, PREVSTOCKING5, PREVSTOCKING5mid
    )]
#   OUT=ALL
...
# --- Save outputs
  cat("Save...\n")
  tic()
    saveRDS(OUT, file = paste0(file.out.base, "_out.rds"))
    saveRDS(ALL, file = paste0(file.out.base, "_all.rds"))
  toc()
